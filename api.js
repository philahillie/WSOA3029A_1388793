...
function drawGraph(dataToShow) {
	...
	const youngAdults = dataToShow.ratingsHistograms["Males Aged 18-29"];
	const adults = dataToShow.ratingsHistograms["Males Aged 30-44"];
	const olderAdults = dataToShow.ratingsHistograms["Males Aged 45+"];

	let data = [

		{ x: "UNDER 18", y: dataToShow.ratingsHistograms["Males Aged under 18"].aggregateRating},
